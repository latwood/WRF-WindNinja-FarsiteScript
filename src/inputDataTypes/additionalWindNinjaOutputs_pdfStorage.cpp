                                                                             ...
                                                                             double new_pdf_height, double new_pdf_width, std::string new_pdf_size)
{
    ...
    new_stringValue1.set_storedStringValue(new_units_pdf_out_resolution);
    ...
    new_stringValue2.set_storedStringValue(new_pdf_basemap);
    ...
    new_stringValue3.set_storedStringValue(new_pdf_size);
