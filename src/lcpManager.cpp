...
bool lcpManager::load_required_inputs(inputVariablesHandler *inputs, double newFirePerimMinLat, double newFirePerimMinLong, double newFirePerimMaxLat, double newFirePerimMaxLong)
{
...
bool lcpManager::automaticLcpDownload()
{
    // if it gets here, everything went well
    return true;
}

bool lcpManager::specifiedLcpDownload()
{
    // if it gets here, everything went well
    return true;
}
