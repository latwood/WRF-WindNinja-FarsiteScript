...
bool inputVariables_valueStorage::set_boolValue_string(std::string varName, std::string newStringBoolValue)
{
    bool success = true;
    ...
    if(foundVarName == false)
    {
        printf("could not set bool value \"%s\" for variable name \"%s\", variableName \%s\" does not exist in bool value storage!\n",newStringBoolValue.c_str(),varName.c_str(),varName.c_str());
        success = false;
    }
...
bool inputVariables_valueStorage::set_size_tValue_string(std::string varName, std::string newStringSize_tValue)
{
    bool success = true;
    ...
    if(foundVarName == false)
    {
        printf("could not set size_t value \"%s\" for variable name \"%s\", variableName \%s\" does not exist in size_t value storage!\n",newStringSize_tValue.c_str(),varName.c_str(),varName.c_str());
        success = false;
    }
...
bool inputVariables_valueStorage::set_intValue_string(std::string varName, std::string newStringIntValue)
{
    bool success = true;
    ...
    if(foundVarName == false)
    {
        printf("could not set int value \"%s\" for variable name \"%s\", variableName \%s\" does not exist in int value storage!\n",newStringIntValue.c_str(),varName.c_str(),varName.c_str());
        success = false;
    }
...
bool inputVariables_valueStorage::set_doubleValue_string(std::string varName, std::string newStringDoubleValue, std::string doubleType)
{
    bool success = true;
    ...
    if(foundVarName == false)
    {
        printf("could not set double value \"%s\" for variable name \"%s\", variableName \%s\" does not exist in double value storage!\n",newStringDoubleValue.c_str(),varName.c_str(),varName.c_str());
        success = false;
    }
...
/*bool inputVariables_valueStorage::set_lat_longValue_string(std::string varName, std::string newStringLatValue, std::string newStringLongValue)
{
    bool success = true;
    ...
    if(foundVarName == false)
    {
        printf("could not set lat_long value \"%s\" \"%s\" (\"lat\" \"long\") for variable name \"%s\", variableName \%s\" does not exist in lat_long value storage!\n",newStringLatValue.c_str(),newStringLongValue.c_str(),varName.c_str(),varName.c_str());
        success = false;
    }
...
bool inputVariables_valueStorage::set_lat_longValue_string(std::string varName, std::string newLatLongValueString)
{
    bool success = true;
    ...
    if(foundVarName == false)
    {
        printf("could not set lat_long value \"%s\" (\"lat\" \"long\") for variable name \"%s\", variableName \%s\" does not exist in lat_long value storage!\n",newLatLongValueString.c_str(),varName.c_str(),varName.c_str());
        success = false;
    }
...
/*bool inputVariables_valueStorage::set_dateValue_string(std::string varName, std::string newStringYearValue, std::string newStringMonthValue, std::string newStringDayValue, std::string newStringHourValue, std::string newStringMinuteValue)
{
    bool success = true;
    ...
    if(foundVarName == false)
    {
        printf("could not set date value \"%s %s %s %s:%s\" (month day year hour:min) for variable name \"%s\", variableName \%s\" does not exist in date value storage!\n",newStringMonthValue.c_str(),newStringDayValue.c_str(),newStringYearValue.c_str(),newStringHourValue.c_str(),newStringMinuteValue.c_str(),varName.c_str(),varName.c_str());
        success = false;
    }
...
bool inputVariables_valueStorage::set_dateValue_string(std::string varName, std::string newDateValueString)
{
    bool success = true;
    ...
    if(foundVarName == false)
    {
        printf("could not set date value \"%s\" (month day year hour:min) for variable name \"%s\", variableName \%s\" does not exist in date value storage!\n",newDateValueString.c_str(),varName.c_str(),varName.c_str());
        success = false;
    }
...
/*bool inputVariables_valueStorage::set_hour_minValue_string(std::string varName, std::string newStringHourValue, std::string newStringMinuteValue)
{
    bool success = true;
    ...
    if(foundVarName == false)
    {
        printf("could not set hour_min value \"%s:%s\" (hour:minute) for variable name \"%s\", variableName \%s\" does not exist in hour_min value storage!\n",newStringHourValue.c_str(),newStringMinuteValue.c_str(),varName.c_str(),varName.c_str());
        success = false;
    }
...
bool inputVariables_valueStorage::set_hour_minValue_string(std::string varName, std::string newHourMinValue)
{
    bool success = true;
    ...
    if(foundVarName == false)
    {
        printf("could not set hour_min value \"%s\" (hour:minute) for variable name \"%s\", variableName \%s\" does not exist in hour_min value storage!\n",newHourMinValue.c_str(),varName.c_str(),varName.c_str());
        success = false;
    }
